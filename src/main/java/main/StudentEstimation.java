...
public class StudentEstimation extends JFrame {
    ...
    public StudentEstimation(Variant variant, Student student, Interface intrface) {
        ...
        correctButton.addActionListener(e -> commentTextField.setText("Задание выполнено корректно"));

        notCompletedButton.addActionListener(e -> commentTextField.setText("Задание не выполнено"));

        withoutCommentButton.addActionListener(e -> commentTextField.setText("Без комментария"));
    }
